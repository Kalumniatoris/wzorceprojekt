...
public abstract class BasicBottle implements Bottle{
	...
	BasicBottle(int capacity, String name) {
	
		this.setCapacity(capacity);
		this.setName(name);
		System.out.println("Bottle created");
	}
	public BasicBottle setType(String type) {
		this.type = type;
	...
	public BasicBottle fill(String type, int amount){
